...
def seed_jobs():
    ...
    with app.app_context():
        # Clear all existing jobs and applications
        print("Clearing existing jobs...")
        Job.query.delete()
        db.session.commit()
        
        # Jobs data with specific IDs and posted dates
        sample_jobs = [
            {
                'id': 1001,
                'title': 'Sous Chef',
                ...
                'posted_at': datetime.fromisoformat('2025-11-11T10:30:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1002,
                ...
                'required_certifications': ['Food Handler Certification'],
                'posted_at': datetime.fromisoformat('2025-11-08T14:20:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1003,
                ...
                'posted_at': datetime.fromisoformat('2025-11-12T08:15:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1004,
                ...
                'posted_at': datetime.fromisoformat('2025-11-10T16:45:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1005,
                ...
                'posted_at': datetime.fromisoformat('2025-11-09T11:30:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1006,
                ...
                'posted_at': datetime.fromisoformat('2025-11-07T09:00:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1007,
                'title': 'Line Cook',
                ...
                'required_skills': ['Cooking', 'Food Safety', 'Inventory Management'],
                'required_certifications': ['Food Handler Certification'],
                'posted_at': datetime.fromisoformat('2025-11-13T07:00:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1008,
                ...
                'required_skills': ['Customer Service', 'Cash Handling', 'Food Safety'],
                'required_certifications': ['Food Handler Certification'],
                'posted_at': datetime.fromisoformat('2025-11-12T13:20:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1009,
                ...
                'required_skills': ['Driving', 'Customer Service', 'Food Safety'],
                'required_certifications': ["Driver's License"],
                'posted_at': datetime.fromisoformat('2025-11-11T15:30:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1010,
                ...
                'required_skills': ['Marketing', 'Customer Service', 'Food Safety'],
                'required_certifications': ['Marketing Certification'],
                'posted_at': datetime.fromisoformat('2025-11-10T10:15:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1011,
                ...
                'required_skills': ['Cooking', 'Food Safety', 'Inventory Management'],
                'required_certifications': ['Food Handler Certification'],
                'posted_at': datetime.fromisoformat('2025-11-09T12:00:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1012,
                ...
                'required_skills': ['Food Safety', 'Inventory Management'],
                'required_certifications': ['Food Safety Certification'],
                'posted_at': datetime.fromisoformat('2025-11-08T14:45:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1013,
                ...
                'required_skills': ['Customer Service', 'Cash Handling', 'Food Safety'],
                'required_certifications': ['Food Handler Certification'],
                'posted_at': datetime.fromisoformat('2025-11-13T08:30:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1014,
                ...
                'required_skills': ['Driving', 'Customer Service', 'Food Safety'],
                'required_certifications': ["Driver's License"],
                'posted_at': datetime.fromisoformat('2025-11-12T09:15:00').replace(tzinfo=timezone.utc)
            },
            {
                'id': 1015,
                ...
                'required_skills': ['Gas leak tests', 'City code adherence'],
                'required_certifications': ['CGLI Inspector'],
                'posted_at': datetime.fromisoformat('2025-11-11T11:00:00').replace(tzinfo=timezone.utc)
            }
        ]
